...
import (
	...
	cloudnativev1alpha11 "github.com/redhat/service-config-operator/pkg/apis/cloudnative/v1alpha11"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &cloudnativev1alpha11.ServiceConfig{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &cloudnativev1alpha11.ServiceConfig{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileServiceConfig) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &cloudnativev1alpha11.ServiceConfig{}
...
func newPodForCR(cr *cloudnativev1alpha11.ServiceConfig) *corev1.Pod {
